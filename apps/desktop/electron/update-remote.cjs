 ...
 *
 * A public install can end up with `origin=git@github.com:eapeli/damon.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/eapeli/damon.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/damon-agent'
