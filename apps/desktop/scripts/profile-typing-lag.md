...
cd apps/desktop
XCURSOR_SIZE=24 DAMON_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/damon-typing
# → /tmp/damon-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/damon-typing.before.heapsnapshot
# → /tmp/damon-typing.after.heapsnapshot
```
