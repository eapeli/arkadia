...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/damon'
...
// / Program Files), which buried any files Damon wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.damonDesktop` is
    ...
    const settings = window.damonDesktop?.settings
