import type { DamonConfigRecord, ToolsetInfo } from '@/types/damon'
...
export function getNested(obj: DamonConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: DamonConfigRecord, path: string, value: unknown): DamonConfigRecord {
...
function personalityOptions(config: DamonConfigRecord): string[] {
