...
import type { OAuthProvider } from '@/types/damon'
...
describe('ProvidersSettings', () => {
  ...
  it('does not offer removal for externally managed providers', async () => {
    listOAuthProviders.mockResolvedValue({
      providers: [
        provider('qwen-oauth', true, {
          ...
          disconnect_hint: 'Use `damon auth add qwen-oauth` or that provider\'s CLI to remove it.',
    ...
    expect(screen.getByText(/managed outside Damon/)).toBeTruthy()
  })
})
