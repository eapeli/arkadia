...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/damon'
 ...
 * log inline — the GUI equivalent of the install step `damon tools` runs
