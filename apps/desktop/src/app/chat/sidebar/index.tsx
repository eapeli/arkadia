...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/damon'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('damon:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('damon:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
