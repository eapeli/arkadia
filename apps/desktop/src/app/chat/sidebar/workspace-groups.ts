...
import type { SessionInfo } from '@/damon'
 ...
 * e.g. `damon-agent/desktop` vs `damon-agent-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => DamonWorktreeInfo | null | undefined
