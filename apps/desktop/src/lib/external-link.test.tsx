...
const desktopWindow = window as unknown as { damonDesktop?: Window['damonDesktop'] }
const initialDamonDesktop = desktopWindow.damonDesktop

function installDesktopBridge(partial: Partial<Window['damonDesktop']> = {}) {
  desktopWindow.damonDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['damonDesktop']
}
...
afterEach(() => {
  ...
  if (initialDamonDesktop) {
    desktopWindow.damonDesktop = initialDamonDesktop
  } else {
    delete desktopWindow.damonDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['damonDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['damonDesktop']['openExternal'] })
