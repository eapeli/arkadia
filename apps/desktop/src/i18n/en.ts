...
export const en: Translations = {
  ...
  boot: {
    ready: 'Damon Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Damon settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingDamonDesktop: 'Starting Damon Desktop…'
    },
    errors: {
      backgroundExited: 'Damon background process exited.',
      backgroundExitedDuringStartup: 'Damon background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Damon backend is older than this desktop build and may not work correctly. Update to align them.',
    updateDamon: 'Update Damon',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Damon Desktop.',
    ...
    native: {
      ...
      inputBody: 'Damon is waiting for your response.',
      turnDoneTitle: 'Damon finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Damon defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Damon is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Damon asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Damon was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Damon follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Damon checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Damon configuration...',
    ...
    gateway: {
      ...
      intro:
        'Damon Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Damon backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset DAMON_DESKTOP_REMOTE_URL and DAMON_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Damon backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Damon backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /damon.',
      ...
      restartingMessage: 'Damon Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Damon ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Damon runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      connectAnother: 'Connect another provider',
      otherProviders: 'Other providers',
      removeConfirm: provider => `Remove ${provider}?`,
      removeExternal: (provider, command) => `${provider} is managed outside Damon. Remove it with ${command}.`,
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Damon desktop' },
    ...
    damonActiveSessions: (version, count) => `Damon ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@damon:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Damon environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Damon will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Damon...',
    placeholderReconnecting: 'Reconnecting to Damon…',
    ...
    attachUrlDesc: 'Damon will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Damon can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Damon from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Damon will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Damon updater will take over in its own window and reopen Damon when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Damon reconnects automatically when it’s back.',
    applyingClose: 'Damon will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Damon needs a one-time install',
    ...
    settingUpTitle: 'Setting up Damon Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Damon CLI or desktop instance is running. Stop any running Damon instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Damon installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Damon Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Damon is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Damon…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Damon',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Damon at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Damon connects automatically',
      loopback: 'Opens your browser to sign in — Damon connects automatically',
    ...
    authorizeThere: 'Authorize Damon there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Damon there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Damon inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Damon will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Damon is restarting...',
      askRestart: 'Ask Damon to restart the server',
      lookingRestart: taskId => `Damon is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Damon is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Damon finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Damon could not restart the server.',
      stillWorking:
        'Damon is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Damon is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Damon gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.damon/config.yaml). Damon won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Damon needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Damon needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Damon Desktop to use Save Image.',
    restartToSaveImages: 'Restart Damon Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `damon gateway` running?'
    }
  },
