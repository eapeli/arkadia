...
- persisted runtime files:
  - `~/.damon/plugins/damon-achievements/state.json` (existing unlock state)
  - `~/.damon/plugins/damon-achievements/scan_snapshot.json` (new)
  - `~/.damon/plugins/damon-achievements/scan_checkpoint.json` (new)
