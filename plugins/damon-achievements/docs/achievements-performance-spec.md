...
Owner: damon-achievements plugin
...
### `GET /api/plugins/damon-achievements/achievements`
...
### `POST /api/plugins/damon-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/damon-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/damon-achievements/overview`
...
- Persist plugin data under:
  - `~/.damon/plugins/damon-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.damon/plugins/damon-achievements/scan_checkpoint.json`
...
- `~/.damon/plugins/damon-achievements/`
