...
- Snapshot persisted at `~/.damon/plugins/damon-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.damon/plugins/damon-achievements/scan_checkpoint.json`.
