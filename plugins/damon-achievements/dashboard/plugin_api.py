...
Mounted at /api/plugins/damon-achievements/ by Hermes dashboard.
"""
...
def state_path() -> Path:
    return get_damon_home() / "plugins" / "damon-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_damon_home() / "plugins" / "damon-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_damon_home() / "plugins" / "damon-achievements" / "scan_checkpoint.json"
