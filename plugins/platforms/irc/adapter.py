...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "damon-bot")
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        if command == "433":
            # Retry with incrementing suffix: damon_, damon_1, damon_2...
...
def check_requirements() -> bool:
    ...
    # damon setup / requirements check path.
...
def interactive_setup() -> None:
    ...
    Lazy-imports ``damon_cli.setup`` helpers so the plugin stays importable
    ...
    print()
    print_success("IRC configuration saved to ~/.damon/.env")
    print_info("Restart the gateway for changes to take effect: damon gateway restart")
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "damon-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "damon-bot"
