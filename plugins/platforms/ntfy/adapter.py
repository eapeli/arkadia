    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "damon-in"              # subscribe topic (incoming)
          publish_topic: "damon-out"     # optional — defaults to topic
...
_ECHO_TAG = "damon-agent"  # tag added to outgoing messages for echo-loop prevention
