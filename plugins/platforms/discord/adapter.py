...
def _read_dm_role_auth_guild() -> Optional[int]:
    ...
    policy, ``~/.damon/.env`` is for secrets only, and this is a
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _command_sync_state_path(self) -> _Path:
        ...
        directory = get_damon_home() / _DISCORD_COMMAND_SYNC_STATE_SUBDIR
        try:
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reload-skills", description="Re-scan ~/.damon/skills/ for new or removed skills")
        ...
        # damon_cli/commands.py automatically appear as Discord slash
        ...
        dropped_over_cap = 0
        try:
            from damon_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from damon_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from damon_cli.commands import discord_skill_commands_by_category
...
def interactive_setup() -> None:
    ...
    from damon_cli.cli_output import (
        prompt,
        prompt_yes_no,
        print_header,
        print_info,
...
def _is_connected(config) -> bool:
    ...
    Looks up via ``damon_cli.gateway.get_env_value`` at call time (not via
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'damon-agent[messaging]'",
        # Interactive setup wizard — replaces the central
        # damon_cli/setup.py::_setup_discord function.  Same shape as Teams.
