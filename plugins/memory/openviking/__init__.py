...
class _VikingClient:
    ...
    def __init__(self, endpoint: str, api_key: str = "",
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "damon")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # against a concurrent increment. See damon-agent#28296 review.
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "damon")
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        and memory extraction never fires for it. See damon-agent#28296.
    ...
    def _tool_read(self, args: dict) -> str:
        ...
        # (e.g. viking://user/damon/.overview.md).
