...
hermes cron create "every 1h" \
  ...
  --script ~/.damon/scripts/watch-site.py \
...
Full automation blueprints gallery: [damon-agent.nousresearch.com/docs/reference/automation-blueprints-catalog](https://damon-agent.nousresearch.com/docs/reference/automation-blueprints-catalog)

Documentation: [damon-agent.nousresearch.com](https://damon-agent.nousresearch.com)

GitHub: [github.com/NousResearch/damon-agent](https://github.com/NousResearch/damon-agent)
