...
Both publish at:
  https://damon-agent.nousresearch.com/docs/llms.txt
  https://damon-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://damon-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/build-a-damon-plugin", "Build a Hermes Plugin", None),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "damon-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/damon-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://damon-agent.nousresearch.com/docs\n",
        "Short index: https://damon-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
