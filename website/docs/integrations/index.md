...
- **[Plugin System](/user-guide/features/plugins)** — Extend Hermes with custom tools, lifecycle hooks, and CLI commands without modifying core code. Plugins are discovered from `~/.damon/plugins/`, project-local `.damon/plugins/`, and pip-installed entry points.
- **[Build a Plugin](/guides/build-a-damon-plugin)** — Step-by-step guide for creating Hermes plugins with tools, hooks, and CLI commands.
