...
- "Edit `~/.damon/SOUL.md` to change Hermes' default personality."
...
You can also define named custom personalities in `~/.damon/config.yaml` under `agent.personalities`.
...
1. Keep a thoughtful global `SOUL.md` in `~/.damon/SOUL.md`
