...
The script reads `~/.damon/.env` for two optional defaults:
...
Helper script: `~/.damon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.damon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.damon/.env`.
...
```bash
python3 ~/.damon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.damon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
