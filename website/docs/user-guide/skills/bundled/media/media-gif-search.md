...
Set your Tenor API key in your environment (add to `~/.damon/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/damon-agent/blob/main/skills/media/gif-search/url)`
