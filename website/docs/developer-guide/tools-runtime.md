...
2. **Plugin tools** — `damon_cli.plugins.discover_plugins()` loads user/project/pip plugins that may register additional tools.
...
- platform presets (`damon-cli`, `damon-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `damon-acp`
