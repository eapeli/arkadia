...
- [Build a Hermes Plugin](/guides/build-a-damon-plugin)
...
If your tool requires an API key, add it to `damon_cli/config.py`:
...
- [ ] Optional: API key added to `OPTIONAL_ENV_VARS` in `damon_cli/config.py`
