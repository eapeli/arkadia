...
```bash
pip install git+https://github.com/NousResearch/damon-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/NousResearch/damon-agent.git
```

You can also pin it in your `requirements.txt`:

```text
damon-agent @ git+https://github.com/NousResearch/damon-agent.git
```
...
|-----------|------|---------|-------------|
| `model` | `str` | `""` | Model in OpenRouter format (defaults to empty; resolved from your damon config at runtime) |
