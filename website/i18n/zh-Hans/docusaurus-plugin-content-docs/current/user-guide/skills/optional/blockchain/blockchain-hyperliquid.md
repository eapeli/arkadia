...
辅助脚本：`~/.damon/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
对于 `state`、`spot-balances`、`fills`、`orders` 和 `review`，当 `~/.damon/.env` 中设置了 `HYPERLIQUID_USER_ADDRESS` 时，地址参数为可选。
