...
def _profile_user_agent() -> str:
    """Return a ``damon-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from damon_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"damon-cli/{_ver}"
    except Exception:
        return "damon-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # damon-cli UA so the catalog endpoint is reachable.
