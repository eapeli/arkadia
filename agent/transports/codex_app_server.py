...
projection into Damon' display, approval bridging, transcript projection into
...
"codex_app_server"`. Damon' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("DAMON_KANBAN_TASK"):
            kanban_db = spawn_env.get("DAMON_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "DAMON_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("DAMON_HOME", os.path.expanduser("~/.damon")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "damon",
        client_title: str = "Damon Agent",
