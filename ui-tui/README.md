...
- Input history is stored in `~/.damon/.damon_history` or under `HERMES_HOME`.
...
```text
ui-tui/
  packages/damon-ink/   forked Ink renderer (local dep)
  src/
    ...
    types/
      damon-ink.d.ts    type declarations for @damon/ink
