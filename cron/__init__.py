"""
Cron job scheduling system for Damon Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    damon gateway install    # Install as a user service
    sudo damon gateway install --system  # Linux servers: boot-time system service
    damon gateway            # Or run in foreground
