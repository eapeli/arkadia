...
~/.damon/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.damon/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.damon/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.damon/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.damon/profiles/*/skills)
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_damon_home()}/skills/; existing skills can be modified wherever they live.\n\n"
