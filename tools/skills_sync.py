...
Copies bundled skills from the repo's skills/ directory into ~/.damon/skills/
...
The manifest lives at ~/.damon/skills/.bundled_manifest.
"""
...
from damon_pkg.constants import get_bundled_skills_dir, get_damon_home, get_optional_skills_dir
...
# damon_cli.profiles.NO_BUNDLED_SKILLS_MARKER (kept as a literal here to
...
def _read_suppressed_names() -> set:
    ...
    to reading ``~/.damon/skills/.curator_suppressed`` directly if that import
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.damon/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.damon/skills/ using the manifest.
    ...
    for skill_name, skill_src in bundled_skills:
        ...
        # (~/.damon/skills/.curator_suppressed) is written when the curator
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.damon/skills/ ...")
