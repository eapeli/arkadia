...
def _cwd_marker(session_id: str) -> str:
    return f"__DAMON_CWD_{session_id}__"
...
class BaseEnvironment(ABC):
    ...
    def __init__(self, cwd: str, timeout: int, env: dict = None):
        ...
        self._snapshot_path = f"{temp_dir}/damon-snap-{self._session_id}.sh"
        self._cwd_file = f"{temp_dir}/damon-cwd-{self._session_id}.txt"
    ...
    def init_session(self):
        ...
        # caused ``C:/Users/.../damon-snap-*.sh: No such file or directory``
    ...
    def _extract_cwd_from_output(self, result: dict):
        """Parse the __DAMON_CWD_{session}__ marker from stdout output.
