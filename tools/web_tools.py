...
def _get_async_call_llm():
    from agent.auxiliary_client import async_call_llm as _fn
    return _fn


def _get_extract_content_or_reasoning():
    from agent.auxiliary_client import extract_content_or_reasoning as _fn
    return _fn


def _get_async_text_auxiliary_client():
    from agent.auxiliary_client import get_async_text_auxiliary_client as _fn
    return _fn
...
def _load_web_config() -> dict:
    """Load the ``web:`` section from ~/.damon/config.yaml."""
    try:
