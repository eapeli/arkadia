...
def isolated_home(monkeypatch):
    ...
    test_home = tempfile.mkdtemp(prefix="damon_test_31179_")
    damon_home = os.path.join(test_home, ".hermes")
    os.makedirs(damon_home)
...
def _fresh_modules():
    """Drop cached damon modules so each test reloads against current env."""
