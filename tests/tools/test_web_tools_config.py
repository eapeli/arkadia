...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_damon_home_override(self, tmp_path):
        """Auth lookup should read from HERMES_HOME/auth.json, not ~/.damon/auth.json."""
...
class TestCheckWebApiKey:
    ...
    def test_tool_gateway_availability_skips_refresh_for_expired_cached_token(
        ...
        monkeypatch.setattr(
            "damon_cli.auth.resolve_nous_access_token",
            _record_refresh,
        )
