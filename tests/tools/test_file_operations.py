...
class TestIsWriteDenied:
    ...
    def test_damon_control_files_requested_writable(self, path):
        from damon_pkg.constants import get_damon_home

        assert _is_write_denied(str(get_damon_home() / path)) is False
    ...
    def test_pairing_dir_denied(self, tmp_path, monkeypatch):
        ...
        PR #30383 introduced ~/.damon/pairing/{platform}-approved.json as the
