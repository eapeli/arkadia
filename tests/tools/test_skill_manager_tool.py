...
def _skill_dir(tmp_path):
    ...
    only the temp directory — not the real ~/.damon/skills/."""
...
class TestSecurityScanGate:
    ...
    def test_guard_flag_reads_config_default_false(self):
        ...
        with patch("damon_cli.config.load_config", return_value={"skills": {}}):
...
class TestExternalSkillMutations:
    ...
    caused agents to create duplicate copies in ~/.damon/skills/ as a
    workaround.
    """
