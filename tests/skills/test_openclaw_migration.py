...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # damon_config_mod  — print statements in the post-migration summary that
    #                      tell the user to *review* ~/.damon/config.yaml;
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "damon_config_mod"}
...
def test_rebrand_text_preserves_filesystem_path_casing():
    ...
    assert mod.rebrand_text("config is at ~/.openclaw/config.yaml") == \
        "config is at ~/.damon/config.yaml"
