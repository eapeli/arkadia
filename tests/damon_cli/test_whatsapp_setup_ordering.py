...
def isolated_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HERMES_HOME", str(damon))
...
def _env_value(damon_home: Path, key: str) -> str | None:
    env_file = damon_home / ".env"
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    monkeypatch.setattr("damon_cli.main._require_tty", lambda *_a, **_kw: None)
