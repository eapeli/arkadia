"""Tests for damon_cli.security_advisories.
...
import damon_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full damon_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "damon_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "damon_cli.config.save_config",
