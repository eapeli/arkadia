...
def _build_parser():
    """Build the damon argument parser from the real code.
...
class TestChatVerboseArg:
    ...
    def test_cmd_chat_forwards_none_when_verbose_is_absent(self, monkeypatch):
        ...
        fake_banner = types.ModuleType("damon_cli.banner")
        ...
        monkeypatch.setitem(sys.modules, "damon_cli.banner", fake_banner)
