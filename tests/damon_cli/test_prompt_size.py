...
from damon_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(damon_home, memory_text="", user_text=""):
    mem_dir = damon_home / "memories"
...
def _seed_skill(damon_home, name, description):
    skill_dir = damon_home / "skills" / "demo" / name
