...
class TestSlackNativeSlashes:
    ...
    def test_damon_catchall_is_first(self):
    ...
    def test_telegram_parity(self):
        ...
        via_damon_norm = {_norm(n) for n in _SLACK_VIA_HERMES_ONLY}
        missing = (tg_norm - slack_norm) - reserved_norm - via_damon_norm
        assert not missing, (
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from damon_cli import commands as commands_mod
        ...
        monkeypatch.setattr(
            "damon_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from damon_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch damon_cli.plugins.get_plugin_commands() to a fixed dict."""
        from damon_cli import plugins as _plugins_mod
