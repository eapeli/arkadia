...
from damon_cli.main import _suppress_mouse_residue_early
...
class TestEarlyMouseDisable:
    def test_writes_disable_sequence_when_tui_flag_in_argv(self, monkeypatch):
        monkeypatch.setattr(sys, "argv", ["damon", "--tui", "-c", "abc"])
    ...
    def test_writes_disable_sequence_when_damon_tui_env_set(self, monkeypatch):
