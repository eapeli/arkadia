...
class TestSlashCommands:
    ...
    @pytest.mark.asyncio
    async def test_legacy_damon_prefix_still_works(self, adapter):
    ...
    @pytest.mark.asyncio
    async def test_legacy_damon_freeform_question(self, adapter):
...
class TestSlashEphemeralAck:
    ...
    @pytest.mark.asyncio
    async def test_legacy_damon_slash_stashes_context(self, adapter):
    ...
    @pytest.mark.asyncio
    async def test_freeform_damon_question_does_not_stash_context(self, adapter):
