...
class TestIsBotMentioned:
    ...
    def test_partial_localpart_no_match(self):
        # "hermesbot" should not match word-boundary check for "damon"
...
class TestStripMention:
    ...
    def test_localpart_in_path_preserved(self):
        ...
        result = self.adapter._strip_mention("read /home/damon/config.yaml")
        assert result == "read /home/damon/config.yaml"
