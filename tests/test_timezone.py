"""
Tests for timezone support (damon_time module + integration points).
...
def _reset_damon_time_cache():
    """Reset the damon_time module cache (replacement for removed reset_cache)."""
    damon_time._cached_tz = None
    damon_time._cached_tz_name = None
    damon_time._cache_resolved = False


# =========================================================================
# damon_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="damon_time"):
            result = damon_time.now()
...
class TestCronTimezone:
    ...
    def test_ensure_aware_naive_preserves_absolute_time(self):
        ...
        Regression: the old code used replace(tzinfo=damon_tz) which shifted
    ...
    def test_ensure_aware_normalizes_aware_to_damon_tz(self):
    ...
    def test_get_due_jobs_naive_cross_timezone(self, tmp_path, monkeypatch):
        ...
        # of the naive timestamp exceeds _damon_now's wall time — this would
