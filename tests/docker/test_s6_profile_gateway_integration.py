...
The unit tests in tests/damon_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned damon-writable by the
...
from damon_cli.service_manager import S6ServiceManager
