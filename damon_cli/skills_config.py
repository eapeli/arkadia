"""
Skills configuration for Damon Agent.
`damon skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.damon/config.yaml under:
...
from damon_cli.config import cfg_get, load_config, save_config
from damon_cli.colors import Colors, color
from damon_cli.platforms import PLATFORMS as _PLATFORMS
