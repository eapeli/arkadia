"""
Damon CLI - Unified command-line interface for Damon Agent.

Provides subcommands for:
- damon chat          - Interactive chat (same as ./damon)
- damon gateway       - Run gateway in foreground
- damon gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `damon setup` on a fresh Pi.
    ...
    damon_cli/stdio.py::configure_windows_stdio() runs later from the entry
