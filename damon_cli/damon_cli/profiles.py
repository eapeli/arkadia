...
def _get_profiles_root() -> Path:
    ...
    Anchored to the damon root, NOT to the current HERMES_HOME
...
def validate_profile_name(name: str) -> None:
    ...
    collisions (a ``hermes`` profile inside ``~/.damon/``) or get refused
...
def get_active_profile_name() -> str:
    ...
    Returns the profile name if HERMES_HOME points into ``~/.damon/profiles/<name>``.
