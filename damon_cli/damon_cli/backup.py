...
`hermes backup` creates a zip archive of the entire ~/.damon/ directory
...
def run_backup(args) -> None:
    ...
    if not damon_root.is_dir():
        print(f"Error: Hermes home directory not found at {damon_root}")
        sys.exit(1)
        ...
        if profiles_dir.is_dir():
            try:
                ...
                if any(profiles_dir.iterdir()):
                    ...
                    print(f"  Run: damon profile list  (after installing hermes)")
...
def restore_cron_jobs_if_emptied(
    ...
    Args:
        ...
        damon_home: Override for the Hermes home directory (tests).
