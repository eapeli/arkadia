...
_DOCS_BASE = "https://damon-agent.nousresearch.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://damon-agent.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://damon-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://damon-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def _offer_openclaw_migration(damon_home: Path) -> bool:
    ...
    if conflicts:
        print_info(f"Skipped {conflicts} item(s) that already exist in Hermes (use damon claw migrate --overwrite to force).")
    if skipped:
