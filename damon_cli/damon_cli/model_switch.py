...
#   NousResearch/Hermes-3-Llama-3.1-70B, damon-4-405b, openrouter/hermes3:70b
...
def list_authenticated_providers(
    ...
    *,
    ...
    from damon_cli.providers import HERMES_OVERLAYS
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        damon_slug = _mdev_to_hermes.get(pid, pid)
