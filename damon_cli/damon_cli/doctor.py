...
_DHH = display_damon_home()  # user-facing display path (e.g. ~/.hermes or ~/.damon/profiles/coder)
...
from damon_cli.models import _HERMES_USER_AGENT
                ...
                try:
                    ...
                    if not configured:
                        _fail_and_issue(
                            ...
                            "(check ~/.damon/.env or run 'hermes setup')",
                            (
