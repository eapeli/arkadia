...
def _kanban_worker_skill_available(damon_home: Optional[str]) -> bool:
    ...
    base = _Path(damon_home) if damon_home else (_Path.home() / ".hermes")
...
def _default_spawn(
    ...
    *,
    ...
    # If HERMES_HOME is absent from the child's env, get_damon_home() falls
...
def build_worker_context(conn: sqlite3.Connection, task_id: str) -> str:
    ...
    if shown_c:
        ...
        for c in shown_c:
            ...
            # operator-controlled HERMES_PROFILE values like "damon-system"
