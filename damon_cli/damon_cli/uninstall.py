    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                ...
                if '# Hermes Agent' in line or '# damon-agent' in line:
                    skip_next = True
                    continue
...
def _uninstall_profile(profile) -> None:
    ...
    #    Use `python -m damon_cli.main` so we don't depend on a `hermes`
...
def run_gui_uninstall(args):
    ...
    if agent_is_installed(damon_home):
        ...
        print(f"  • The Hermes agent at {damon_home / 'damon-agent'}")
    ...
    print(color("└─────────────────────────────────────────────────────────┘", Colors.GREEN, Colors.BOLD))
    print()
    print("The Hermes agent is still installed. Run 'damon' to use the CLI,")
