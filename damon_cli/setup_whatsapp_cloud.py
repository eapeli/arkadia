...
Entry point: ``damon whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``damon_cli/main.py``).
...
Damon gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Damon to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Damon needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Damon gateway in another terminal:")
    print("         damon gateway")
    print()
    ...
    print()
    print("  Docs: https://damon-agent.nousresearch.com/docs/user-guide/")
