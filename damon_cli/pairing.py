...
Usage:
    damon pairing list              # Show all pending + approved users
    damon pairing approve <platform> <code>  # Approve a pairing code
    damon pairing revoke <platform> <user_id> # Revoke user access
    damon pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle damon pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: damon pairing {list|approve|revoke|clear-pending}")
        print("Run 'damon pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.damon/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'damon pairing list' to see pending codes.\n")
