...
from damon_cli.timeouts import (
    get_provider_request_timeout,
    get_provider_stale_timeout,
)

_damon_home = get_damon_home()
_damon_home = _damon_home
_project_env = Path(__file__).parent / '.env'
_loaded_env_paths = load_damon_dotenv(damon_home=_damon_home, project_env=_project_env)
...
class AIAgent:
    ...
    _TOOL_CALL_ARGUMENTS_CORRUPTION_MARKER = (
        "[damon-agent: tool call arguments were corrupted in this session and "
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from damon_cli.models import ensure_lmstudio_model_loaded
    ...
    def _codex_silent_hang_hint(self, model: Optional[str] = None) -> Optional[str]:
        ...
        damon-agent #21444 for the symptom history.  The upstream backend
        ...
        return (
            ...
            "See damon-agent#21444 for symptom history."
        )
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("damon_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from damon_cli import plugins as _plugins
    ...
    def _save_session_log(self, messages: List[Dict[str, Any]] = None):
        ...
        whose external tooling consumes ``~/.damon/sessions/session_{sid}.json``
    ...
    def _format_file_mutation_failure_footer(cls, failed: Dict[str, Dict[str, Any]]) -> str:
        ...
        (e.g. ``~/.damon/config.yaml``) to a messaging channel (#35584).
        """
        if not failed:
            return ""
        lines = [
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from damon_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from damon_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from damon_cli.models import lmstudio_model_reasoning_options
