...
try:
    ...
    _DAMON_VERSION = "0.0.0"

_APP_VERSION = _DAMON_VERSION
_BOT_VERSION = _DAMON_VERSION
_YUANBAO_INSTANCE_ID = str(DAMON_INSTANCE_ID)  # single source: yuanbao_proto.DAMON_INSTANCE_ID
