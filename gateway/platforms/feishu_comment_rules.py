...
Config: ~/.damon/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.damon/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_damon_home()`` helper (DAMON_HOME-aware and
...
RULES_FILE = get_damon_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_damon_home() / "feishu_comment_pairing.json"
