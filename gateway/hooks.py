...
Hooks are discovered from ~/.damon/hooks/ directories, each containing:
...
HOOKS_DIR = get_damon_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"damon_hook_{hook_name}"
