#!/usr/bin/env python3
"""
SWE Runner with Damon Trajectory Format

A runner that uses Damon-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Damon-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Damon-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Damon format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Damon-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Damon-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Damon Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Damon-Agent's built-in execution environments
    and outputs trajectories in Damon-Agent format.
    """
    ...
    def _convert_to_damon_format(
        ...
        """
        Convert internal message format to Damon trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Damon trajectory format
        trajectory = self._convert_to_damon_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Damon trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Damon Trajectory Format")
    print("=" * 60)
