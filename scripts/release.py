...
VERSION_FILE = REPO_ROOT / "damon_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+damon-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: damon-eval community link)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"damon-agent[acp]=={semver}"
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/damon-agent",
