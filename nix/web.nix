# nix/web.nix — Damon Web Dashboard (Vite/React) frontend build
{ pkgs, damonNpmLib, ... }:
let
  npm = damonNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "damon-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../damon_cli/web_dist for the
