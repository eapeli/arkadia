...
toolsets it needs. Only references skills that ship in the public damon-agent
...
### Visual / rendering skills (`damon-agent/skills/creative/`)
...
### Design / pre-production skills (`damon-agent/skills/creative/`)
...
### Audio / media skills (`damon-agent/skills/creative/` + `skills/media/`)
...
### Kanban infrastructure (`damon-agent/skills/devops/`)
