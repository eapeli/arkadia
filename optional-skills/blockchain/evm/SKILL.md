...
Helper script path: `~/.damon/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.damon/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.damon/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.damon/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
